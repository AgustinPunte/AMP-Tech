...
String get_plate(){   // En la solucion final esta funcion devuelve el camion que esta parkeando
  return "0407-FCM";
...
void publishSmallJson() {
  ...
  doc["spot"] = get_park(); // Add names and values to the JSON document
  doc["plate"]  = get_plate(); // Add names and values to the JSON document
